...
namespace FieldValidatorAPI
{
	...
	{
		private static RequireValidDel _requiredValidDel = null;
		...
		public static RequireValidDel RequiredFieldValidDel
		{
			get
			{
				if (_requiredValidDel == null)
					_requiredValidDel = new RequireValidDel(RequiredFieldValid);
