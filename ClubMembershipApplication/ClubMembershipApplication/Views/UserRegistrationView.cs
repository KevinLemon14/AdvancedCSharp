...
namespace ClubMembershipApplication.Views
{
	public class UserRegistrationView : IView
	{
		...
		public void RunView()
		{
			...
			_fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.Password] = GetInputFromUser(FieldConstants.UserRegistrationField.Password, $"Please enter your passsword. {Environment.NewLine}(Your password must contain 1 upper-case letter, 1 lower-case letter, 1 special character and be between 6-10 characters long: ");
