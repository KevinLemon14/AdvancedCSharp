...
namespace SchoolHRAdministration
{
	...
	class Program
	{
		...
		public static void SeedData(List<IEmployee> employees)
		{
			...
			IEmployee deputyHeadTeacher = EmployeeFactory.GetEmployeeInstance(EmployeeType.DeputyHeadTeacher, 4, "Devlin", "Brown", 60000);
			employees.Add(deputyHeadTeacher);

			IEmployee headTeacher = EmployeeFactory.GetEmployeeInstance(EmployeeType.HeadTeacher, 5, "Damien", "Jones", 80000);
    ...
    public class  HeadTeacher: EmployeeBase
    {
		...
		public static IEmployee GetEmployeeInstance(EmployeeType employeeType, int id, string firstName, string lastName, decimal salary)
		{
			...
			switch (employeeType)
			{
				...
				case EmployeeType.DeputyHeadTeacher:
					employee = FactoryPattern<IEmployee, DeputyHeadTeacher>.GetInstance();
					break;
				case EmployeeType.HeadTeacher:
					employee = FactoryPattern<IEmployee, HeadTeacher>.GetInstance();
					break;
				default:
					break;
			}
